...
const translations = {
  en: {
    ...
    aboutText1:
      "Whisper of Flower is a place where every bouquet is created with love and care.",
    aboutText2:
      "We believe that flowers are not just decor, but a true language of feelings. Our florists create unique compositions that convey emotions and inspire. In every petal, we put a piece of our soul, making your gift special.",
    aboutText3:
      "Our assortment includes flowers for any occasion — from romantic surprises to grand events. We care about the quality of every bouquet and your emotions, because our goal is to make the world brighter, gentler, and warmer.",
    aboutText4:
      "Whisper of Flower is more than a flower shop. It's a place where flowers speak, and the whisper of petals tells your story.",
    ...
    review1Text:
      "“The flowers were enchanting, thank you for the fast delivery!”",
    review1Author: "— Anna",
    ...
    review5Text:
      "“The bouquet was simply amazing, the aroma filled the whole room!”",
    review5Author: "— Iryna",
    review6Text:
      "“Thanks for the individual approach — helped choose the perfect option for my wife.”",
    review6Author: "— Serhiy",
    review7Text:
      "“Delivery on time, everything neat and tasteful. I will definitely order again!”",
    review7Author: "— Andriy",
    review8Text:
      "“The composition was a true masterpiece, all guests were delighted!”",
    ...
    footerAboutDesc:
      "Flower shop where every bouquet is created with love and care. Gift emotions in every petal!",
  ...
  ua: {
    ...
    aboutText1:
      "Whisper of Flower – це місце, де кожен букет створюється з любов’ю та ніжністю.",
    aboutText2:
      "Ми віримо, що квіти — це не просто декор, а справжня мова почуттів. Наші флористи створюють унікальні композиції, які передають емоції та дарують натхнення. У кожній пелюстці ми вкладаємо частинку душі, щоб ваш подарунок став особливим.",
    aboutText3:
    ...
    review5Author: "— Ірина",
    review6Text:
      "“Дякую за індивідуальний підхід — допомогли підібрати ідеальний варіант для дружини.”",
    review6Author: "— Сергій",
    review7Text:
      "“Доставка вчасно, все акуратно та зі смаком. Обов’язково замовлю ще!”",
    review7Author: "— Андрій",
    review8Text:
      "“Композиція була справжнім витвором мистецтва, усі гості захоплювались!”",
    ...
    footerAboutTitle: "Whisper of Flower",
    footerAboutDesc:
      "Магазин квітів, де кожен букет створюється з любов’ю та ніжністю. Подаруйте емоції у кожній пелюстці!",
    footerCopyright: "© 2025 Whisper of Flower",
    ...
    loginNoAccount:
      'Не маєте аккаунту? <a href="Register.html">Зареєструватися</a>',
    loginBtn: "Увійти",
    //Register-page
...
function applyTranslation(lang) {
  ...
  const titleKey =
    document.body.getAttribute("data-page-title") || "indexTitle";
